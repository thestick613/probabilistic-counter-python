...
#
# However, when we do this, we also import `probcount/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'probcount_cli = probcount.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'probcount_gui = probcount.gui:entry_point'
        # ]
    }
)
